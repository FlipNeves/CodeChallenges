...
ListNode listNode = new ListNode(1, new ListNode(2, new ListNode(2, new ListNode(2, new ListNode(1, null))))); //[1,2,2,2,1]
//ListNode listNode = new ListNode(1, new ListNode(0, new ListNode(0, null)));

var val = _LeetCodeMethods.IsPalindrome(listNode);
